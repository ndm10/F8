...
//        processRequest(request, response);
        ...
        ArrayList<CourseDetail> listCourseDetailTitle = c.getAllCourseByTitle(searchtxt);
        ArrayList<CourseDetail> listC = c.getAllCourse();
        ArrayList<CourseDetail> listProCourse = c.getAllProCourse();
        request.setAttribute("listProCourse", listProCourse);
        request.setAttribute("listCourse", listC);
        
        request.setAttribute("listCourseDetailTitle", listCourseDetailTitle);
...
//        processRequest(request, response);
        ...
        request.setAttribute("listCourseDetailTitle", listCourseDetailTitle);
        request.setAttribute("txt", searchtxt);
        request.setAttribute("xemthem", "xt");
        request.getRequestDispatcher("home.jsp").forward(request, response);
