            ...
            <div style="display: flex ;
                ...
                <div class="all">
                    <div style="text-align: center">
                        <a href="/g4/home">
                            <img src="./image/f8_logo.png" alt="Avatar"  class="avatar" >
                        </a>
                        <h1 class="h1"> 
                            Lấy lại mật khẩu</h1>  
                    </div>
                    <div class="khung" >
                        <h4 style="margin-left: 125px;
                        ...
                        <div class="form-group" style="
                            ...
                            <div class="ma" id="submit-button" type="submit" >
                                <input class="guima" id="span" type="submit" name="sendCodeBtn" value="Gửi mã" style="cursor: pointer" >
                            </div>
                            <!--                            <div class="ma" id="submit-button"  >
                                                            <input class="guima" id="span" type="submit" name="sendCodeBtn" value="Gửi mã" style="cursor: pointer" >
                                                        </div>-->
